...
#./vdb-config -i
./prefetch --ngc ~/prj_29701.ngc SRR443395   #--max-size 100G
mv ~/SRR/sra/SRR443395_dbGaP-*.sra  ~/SRR/sra/SRR443395.sra
./sam-dump --ngc ~/prj_29701.ngc ~/SRR/sra/SRR443395.sra --output-file ~/s84/SRR443395.sam
cd
aws s3 cp s3://unictbcd/SRR442825/557462_ordered.bam s84/
aws s3 cp s3://unictbcd/SRR442825/557462_ordered.bai s84/
mkdir s84/output
mkdir s84/output/bam_tumor
mv s84/557462_ordered.bai s84/output/bam_tumor/
mv s84/557462_ordered.bam s84/output/bam_tumor/
mv s84/SRR443395.sam s84/557462_normal.sam
bash pipeline_sing_nor.bash -f file/s84.txt
ls
